...
<script>
     ...
     var host = "ws://ssv2:1234";
//     var host = 'https://<?//= $server ?>///recorder';
...
//             socket.emit("sound", e.inputBuffer.getChannelData(0));
//                stream.write(e.inputBuffer.getChannelData(0));
         };
...
//            console.log('Recieve Chunk: ' + chunk);
//        data.push(chunk);
