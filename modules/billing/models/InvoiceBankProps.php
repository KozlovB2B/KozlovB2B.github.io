...
/**
 * This is the model class for table "billing_invoice_bank_props".
 *
 * @property integer $id
 * @property integer $invoice_id
 * @property integer $is_payer
 ...
 */
class InvoiceBankProps extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'billing_invoice_bank_props';
    }
    ...
    {
        return [
            [['invoice_id', 'is_payer', 'inn', 'kpp', 'ogrn'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('billing', 'ID'),
            'invoice_id' => Yii::t('billing', 'Invoice'),
            'is_payer' => Yii::t('billing', 'Is it payer'),
