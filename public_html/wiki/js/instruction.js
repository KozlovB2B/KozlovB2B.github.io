    ...
    return function (a) {
        ...
        (function (b) {
            ...
            function g(a) {
                ...
                var j = {width: f.dimensions.width, height: f.dimensions.height, theme: f.theme, flags: f.flags}, k = h(j);
            ...
            function h(a) {
                ...
                var d = new w({width: a.width, height: a.height}), e = d.Shape, f = new e.Rect("holderBg", {fill: a.theme.background});
            ...
            var v = c(1), w = c(2), x = c(3), y = x.extend, z = x.cssProps, A = x.encodeHtmlEntity, B = x.decodeHtmlEntity, C = x.imageExists, D = x.getNodeArray, E = x.dimensionCheck, F = "http://www.w3.org/2000/svg", G = 8, H = "2.6.0", I = "\nCreated with Holder.js " + H + ".\nLearn more at http://holderjs.com\n(c) 2012-2015 Ivan Malopinsky - http://imsky.co\n", J = {
                ...
                }, defaults: {size: 10, units: "pt", scale: 1 / 16}, flags: {
                    dimensions: {
        ...
        var d = c(4), e = function (a) {
            ...
            var c = 1, e = d.defclass({
                ...
                this.Group = d.extend(this, {constructor: c, type: "group"}), this.Rect = d.extend(this, {constructor: c, type: "rect"}), this.Text = d.extend(this, {
                    constructor: function (a) {
...
!function (a) {
    ...
    a(function () {
        ...
        c.scrollspy({target: ".ss-instruction-sidebar"}), b.on("load", function () {
            c.scrollspy("refresh")
        })
    ...
    "use strict";
    anchors.options.placement = "left", anchors.add(".ss-instruction-section > h1, .ss-instruction-section > h2, .ss-instruction-section > h3, .ss-instruction-section > h4, .ss-instruction-section > h5")
}();